PRO qmom_test, e1, e2, xabs, yabs, cenx, ceny, Rmax, sigma, qMap, qrad, qMaperr, qraderr, nobj=nobj
...
;      frad = w^2*Q*erad
      ...
      ENDIF ELSE BEGIN 
          ...
          qrad = qrad + total( temporary(fsend) )
      ENDELSE 
    ;  qMap = qMap * Area^2/wtot^2
    ;  qrad = qrad * Area^2/wtot^2

      qMap = qMap * Area^2/nobj/(nobj-1)
      qrad = qrad * Area^2/nobj/(nobj-1)
  ENDELSE 
