PRO fit_wtheta_high, meanr, diffdensecomb, errorcomb, cumul, xx, yycomb
  ...
  w=where(wt.meanr NE 0.,nbin)
  w2=where(wt2.meanr NE 0.,nbin2)
w=w2
  ;; density in #/Mpc^2
  ...
  minpow = -0.9 & maxpow = -0.7
  minnorm = 1.0 & maxnorm = 3.0
  npow = 100L
  nnorm = 100L
  ...
  ;oplot,xx, modely_highcomb,color=!blue,line=2
  ;oplot,xx, modely_lowcomb,color=!blue,line=2
