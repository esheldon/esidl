...
;  nall = n_elements(allcat)
  ...
  rmin = 20.
  IF n_elements(rmax) EQ 0 THEN rmax = 2100.
  ...
  wtheta_lensgal_lcut_logbin, nbin, wclr, stripe, spectra, $
    allcat, rmin, rmax, $
...
jump:
  ...
  wthetarand_lensgal_lcut_logbin, nbin, wclr,stripe,$
    allcat,rmin,rmax,zrand,ndup, $
    use_lambda=use_lambda, step=step, $
