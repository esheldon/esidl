PRO wtheta_lensgal_lumweight, wclr, stripe, lenscat, allcat, rmin, rmax, binsize, $
                         ...
                         maxe=maxe,fraclstar=fraclstar,numfile=numfile,nbeta=nbeta

  IF n_params() LT 7 THEN BEGIN
      print,'-Syntax: wtheta_lensgal_lumweight, wclr, stripe, lenscat, allcat, rmin, rmax, binsize,'
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  FOR group = 0L, nstep-1 DO BEGIN
      ...
      IF nneigh NE 0 THEN BEGIN 
          ...
          IF total(lwsum) NE 0 THEN $
            print,'Mean Lum: '+ntostr(total(lsum)/total(lwsum))
