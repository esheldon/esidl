PRO run_wtheta_lcut_radec_logbin, wclr, ndup, stripe, nbin, $
                                  indir=indir, outdir=outdir, $
                                  use_lambda=use_lambda,fraclstar=fraclstar,$
                                  numfile=numfile,nbeta=nbeta, $
                                  tsgals=tsgals,rmax=rmax, $
                                  edgecut=edgecut, racut=racut, $
                                  maskdir=maskdir, $
  ...
  IF n_params() LT 4 THEN BEGIN
      print,'-Syntax: run_wtheta_lcut_radec_logbin, wclr, ndup, stripe, nbin, indir=indir, outdir=outdir, use_lambda=use_lambda,numfile=numfile,nbeta=nbeta, rmax=rmax, tsgals=tsgals,rmax=rmax'
      return
  ENDIF 
...
;  ENDCASE 
  ...
  wtheta_lensgal_lcut_radec, wclr, stripe, spectra, allcat, rmin, rmax, nbin, $
    ...
    edgecut=edgecut, racut=racut, $
    maskdir=maskdir, etarangedir=etarangedir,/logbin
...
jump:
  ...
  wthetarand_lensgal_lcut_radec,wclr,stripe,allcat,rmin,rmax,nbin,zrand,ndup, $
    lensra, lensdec, $
    use_lambda=use_lambda, step=step, $
    outdir=outdir, zfile=zfile,$
    numfile=numfile,nbeta=nbeta,fraclstar=fraclstar, tsgals=tsgals, $
    edgecut=edgecut, maskdir=maskdir, etarangedir=etarangedir,/logbin
