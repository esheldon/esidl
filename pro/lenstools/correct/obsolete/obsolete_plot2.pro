pro plot2,x,y,sig,a,b,xtitle,ytitle,xrange,yrange,title
...
;  aploterror,1,x,y,sig,psym=3,xtitle=xtitle,ytitle=ytitle,yrange=yrange,xrange=xrange,title=title
  ploterror,x,y,sig,psym=3,xtitle=xtitle,ytitle=ytitle,$
            yrange=yrange,xrange=xrange,title=title, psym=psym
  yy=a+b*xx
  oplot,xx,yy
