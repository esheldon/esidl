PRO makecor_retmom, run, rerun, camcol, start=start, nframes=nframes, stmaxmag=stmaxmag

  IF n_params() LT 3 then begin
      print,'-syntax makecor, run, rerun, camcol, start=start, nframes=nframes, stmaxmag=stmaxmag'
      return
  ENDIF
  ...
  FOR ic = 0L, nframes-1 DO BEGIN 
      ...
      FOR iband = 0, nband-1 DO BEGIN 
          ...
          tmp_psfe1 = (psfixx - psfiyy)/psfsize

          tmp_psfe2 = 2.*psfixy/psfsize
...
jump2:
                                ;Free up the memory
      pstruct = 0 & psfstr = 0 & cor1=0
      psfsize=0 &  psfixx=0 &  psfiyy=0 &  psfixy=0 &  psfrho4=0
      psfe1=0 &  psfe2=0 &  obje1=0 &  obje2=0
