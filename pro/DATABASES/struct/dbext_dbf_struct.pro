pro dbext_dbf_struct,list,dbno,sbyte,nbytes,idltype,nval,struct, $
                     item_dbno=item_dbno
;+
; NAME:
;       DBEXT_DBF
; PURPOSE:
;       Subroutine of DBEXT to extract values from an database. The use of
;       structures means there is no practical limit to the number of columns
;       that can be extracted.
;
; EXPLANATION:
;       This is a subroutine of DBEXT_STRUCT, which is the routine a user
;       should normally use.
;
; CALLING SEQUENCE:
;       dbext_dbf,list,dbno,sbyte,nbytes,idltype,nval, struct, ITEM_DBNO = ]
;
; INPUTS:
...
;
; OUTPUTS:
;       struct: Structure containing the requested items.
;
...
;       9-May-2004 Converted to return a structure E. Sheldon 9-Mar-2004
;-
;
;*****************************************************************
;
...
;
  ...
  for i = 0,nitems-1 do begin
      ...
      IF nlist GT 1 THEN BEGIN 
          struct.(i) = reform(item, /overwrite)
      ENDIF ELSE BEGIN 
          struct.(i) = item
      ENDELSE 
