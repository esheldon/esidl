PRO  red_fit, cZ, sigma, X, coeffs, predicted, degree
...
;           X:        the color magnitudes for each cZ. X=dblarr[Num2,6]
...
;*****************************************************************************
	...
	IF N_PARAMS() eq 0 THEN BEGIN
		...
		PRINT,"Syntax - red_fit, cZ, sigma, X, coeffs, predicted, degree"
		return
	END
