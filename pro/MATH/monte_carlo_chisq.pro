PRO monte_carly_chisq, datax, data, covariance, data_resamp, Nresamp, $
          pmin, nmin, pminr, nminr, level, chisq_surf, powvals, normvals, $
          diagonal=diagonal

  ;; monte carlo to see what % of points lie within
  ;; the usual gaussian 1-sigma, 2-sigma, etc, bounds
