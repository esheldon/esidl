PRO  oplotderror, x, y, xlow, xhigh, ylow, yhigh, NOHAT=hat, HATLENGTH=hln, ERRTHICK=eth, $
...
;
 ...
 IF (np LT 6) THEN BEGIN
      print, "OPLOTERR must be called with 6 parameters."
      print, "Syntax: oploterror, x, y, xlow, xhigh, ylow, yhigh [..oplot keywords... "
...
;
 ...
 if (!X.type EQ 1) then xlo = xlo > 10^xcrange[0]
