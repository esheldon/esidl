PRO plotthreeerr, x1, y1, y1err, x2, y2, y2err, x3, y3, y3err, $
...
;  IF (np LT 2) OR (np GT 3) THEN BEGIN 
  ...
  ploterror, x2, y2, y2err, position=position2, /device, /noerase, _extra=extra, $
             xtitle=xtitle, ytitle=midytitle, $
  ...
  ploterror, x3, y3, y3err, position=position3, /device, /noerase, _extra=extra, $
