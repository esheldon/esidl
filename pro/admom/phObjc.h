...
#define OBJECT2_AMOMENT_FAINT 0x200000	/* too faint for adaptive moments */
...
#define OBJECT2_SPARE5 0x8000000	/* unused */
 ...
 */
   ...
   float Mcc, MccErr, Mcr, McrErr, Mrr, MrrErr; /* Adaptive second moments */
   float Mcc_psf, Mcr_psf, Mrr_psf;	/* Adaptive second moments of PSF */
   float Mcr4;				/* Adaptive fourth moment of object */
   float Mcr4_psf;			/*                           and PSF */
/*
 ...
 */
   ...
   float Mcc[NCOLOR], MccErr[NCOLOR];
   float Mcr[NCOLOR], McrErr[NCOLOR];
   float Mrr[NCOLOR], MrrErr[NCOLOR];
   float Mcr4[NCOLOR];
   float Mcc_psf[NCOLOR], Mcr_psf[NCOLOR], Mrr_psf[NCOLOR];
   float Mcr4_psf[NCOLOR];
/*
