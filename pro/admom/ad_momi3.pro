...
PRO ad_momi3, im, incenx, inceny, shiftmax, $
             sky, skysig, $
             ixx, iyy, ixy, rho4, uncert, $
             wcenx, wceny, numiter, whyflag
  ...
  ;; I THINK THIS ONE DIFFERS FROM THE OTHERS IN THAT IT
  ;; ATTEMPTS NO INTERPOLATION
  ...
  FOR kk=0, nobj-1 DO BEGIN 
      ...
      WHILE (imom LT maxit) DO BEGIN ; iterate
          ...
          IF (w[0,0] LT xinterp OR w[1,1] LT xinterp OR $
              detw LT xinterp2) THEN interpflag = 1
